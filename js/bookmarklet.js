...
ScientificWeiboSearch.prototype.startloading = function () {
  ...
  s.innerHTML = '#results { width:500px; border:1px solid black;  background-color:white; box-shadow:5px 5px 5px black; position:float; top: 150px; left:150px; z-index:99999 }
  .res { margin-top:2px;}';
